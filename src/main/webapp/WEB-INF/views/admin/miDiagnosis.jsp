...
<script type="text/javascript">
    ...
    $(function() {
        ...
        importExcel();
        miDiagnosisDataGrid = $('#miDiagnosisDataGrid').datagrid({
            url : '${path }/miDiagnosis/miDiagnosisDataGrid',
            fit : true,
            striped : true,
           // rownumbers : true,
            pagination : true,
          ...
          //  idField : 'id',
            ...
            columns : [ [ {
                ...
                width : '15%',
                title : '<font size="3px">自适应症包编码</font>',
                field : 'adaptionPackageCode'
    	...
    	$('#diagnosisEditForm').form({
   		 url :'${path }/miDiagnosis/updateMIDiagnosis',
   		 onSubmit : function() {
                  progressLoad();
              ...
              success : function(result) {
              	...
              	{
               	   hideDiv2();
               	miDiagnosisDataGrid.datagrid('load', $.serializeObject($('#searchForm')));
    ...
    function deleteFun() {
       /*  if (id == undefined) {//点击右键菜单才会触发这个
   	 ...
   	 var ss = "";
     var rows = $('#miDiagnosisDataGrid').datagrid('getSelections');
     if(rows.length<1){
     ...
     for(var i=0; i<rows.length; i++){
        ...
        parent.$.messager.confirm('询问', '您是否要删除当前记录？', function(b) {
            if (b) {
                ...
                if (b) {
                    progressLoad();
                    $.post('${path }/miDiagnosis/deleteMIDiagnosis', {
                        id : ss
                    }, function(result) {
                        if (result.success) {
                            parent.$.messager.alert('提示', result.msg, 'info');
                            miDiagnosisDataGrid.datagrid('reload');
                        }
                        progressClose();
                    }, 'JSON');
                }
    ...
    function editDiagnosisFun() {
        ...
        if(rows.length>1){
    	 ...
    	 $.post('${path }/miDiagnosis/editPage', {
    		 Id : id
           }, function(result) {
          	 showDiv2(); 
               $('#id').val(result.id);
               ...
               $('#adaptionPackageCodeEdit').val(result.adaptionPackageCode);             
    ...
    function cleanFun() {
    	 $('#searchForm')[0].reset();
        miDiagnosisDataGrid.datagrid('load', {});
    }
    ...
    function importExcel()
    {
    	var imgobjs=document.getElementById("daoru");
       	...
       	$(imgobjs).fileUpload(
    		{
    			uploadURL : '${path}/miDiagnosis/importExcel',
    ...
    function exportMIDiagnosis()
    {
    	...
    	location.href='${path}/miDiagnosis/exportMIDiagnosis';
    	
    }
    function exportMIDiagnosisHistory()
    {
    	parent.$.messager.alert({
            title : '提示',
            msg : '正在导出数据... 请耐心等待！'
    	...
    	location.href='${path}/miDiagnosis/exportMIDiagnosisHistory';
    }
    function exportTemp()
    {
    	location.href='${path}/miDiagnosis/exportTemp';
    }
</script>
</head>
<body>
...
<jsp:include page="../include/tophead.jsp" />
	...
	<div class="body-width fs_18 bold header-color">适应症诊断对应</div>
  ...
  <div  style="width: 80%;float: left">
    <table class="ys-table" style="width: 95%">
        ...
        <tr>
            ...
            <td>
               <input name="diagnosisCode"  id="" style="width:120px;height: 30px;" />
            </td>
            ...
            <td>
               <input name="diagnosisName"  id="" style="width:120px;height: 30px;" />
            </td>
   ...
   <table id="btn-table" class="float margin-top10" style="width: 100%;">
    <tr>
        ...
        <td class="right" style="width: 80px">
            <button class="btn-ok fs_16" onclick="exportMIDiagnosis()">导出明细</button>
        </td>
        <td class="right" style="width: 96px">
            <button class="btn-ok fs_16" style="width: 91px;" onclick="exportMIDiagnosisHistory()">查看历史记录</button>
        </td>
    </tr>
</table>

	<div class="body-width   margin-top15" style="height: 340px; overflow-x: auto;">
		<table class="sf-msg-table border-val" id="miDiagnosisDataGrid"style="width: 100%">
    ...
    <div class="DialogDiv1" style="display: none">
        <div class="pop-up bg-color1">
            <span class="float pop-up-span width-color dis-block">适应症诊断对应新增</span>
        </div>
                ...
                <tr>
                    ...
                    <td>
                      ...
                      <input name="diagnosisCode"  id="diagnosisCodeAdd" type="text" class="easyui-validatebox" validateOnCreate="false"
                        validType="account[1,20]"  data-options="required:true" >
                    </td>
                    <td>
                        <span class="bz-zd-table-span">*</span>自适应症包编码
                    </td>
                    <td >
                       <input name="adaptionPackageCode" type="text"  id="adaptionPackageCodeAdd" class="easyui-validatebox" validateOnCreate="false"
    ...
    <div class="DialogDiv2" style="display: none">
        <div class="pop-up bg-color1">
            <span class="float pop-up-span width-color dis-block">适应症诊断对应修改</span>
        </div>
        ...
        <div class="body-width border-val" style="height: 250px;margin-top: 20px !important;width: 94%;margin-left: 3%;">
               <table class="bz-zd-table">
                ...
                <tr>
                    ...
                    <td >
                       <input name="adaptionPackageCode" type="text"  id="adaptionPackageCodeEdit" class="easyui-validatebox" validateOnCreate="false"
                         validType="account[1,5]"   data-options="required:true" >
                    </td>
                    <td>
                        <span class="bz-zd-table-span">*</span>医保诊断名称
