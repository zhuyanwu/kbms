...
function insertDrgs() {
	 $.ajax({
         ...
         success: function(data){         
      	...
      	drgsDataGrid.datagrid('load', {type:'1'});
      	$('#drgsTable input ').val(''); 
         	}else{
      ...
      <form id="drgsForm" action="">
        <table class="input-table" id="drgsTable">
            ...
            <tr>
                <td>治疗方式编码</td>
                <td>
                    <input  name="zlfsbm"  id="zlfsbm"type="text"/>
                </td>
                <td>治疗方式名称</td>
                <td>
                    <input name="zlfsmc" id="zlfsmc" type="text"/>
                </td>
            </tr>
            <tr>
                <td>医疗总费用限额</td>
            ...
            <tr>
                <td>限定住院时间</td>
                <td>
                    <input name="xdzysj"  id="xdzysj" type="text"/>&nbsp;天
                </td>
                <td>报销比例</td>
                <td>
    ...
    $(function () {
        ...
        $("#drgsSubjectTable").on("click",".add-tr",function(){
            //切换选中的按钮高亮状态
             if(flag==1){      
            total=total+1;
           var tr_html = "<tr class='border-tp'><td>项目类型 </td> <td><select name='xmlb'  id='xmlb"+total+"'> <option value=''>请选择</option> <option value='2'>政策内药品目</option>   <option value='3'>政策内诊疗项目</option></select></td>"+
                   "<td>项目编码</td><td><input  name='xmbm'  id='xmbm"+total+"'  type='text'></td><td>项目名称</td><td><input name='xmmc'  id='xmmc"+total+"'  type='text'></td></tr>"+
                   ...
                   "<td> <img    class='add-tr'   src='../static/style/images/add.png'></td><td class='padding-left10'><img class='del-tr'  onclick='deleteCurrentRow(this)'   src='../static/style/images/del.png'></td> ";  
