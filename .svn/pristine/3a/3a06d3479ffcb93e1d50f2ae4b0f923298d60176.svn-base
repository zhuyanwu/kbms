...
<script type="text/javascript">
    ...
    $(function() {    	
        ...
        importExcel();
        miStandardDataGrid = $('#miStandardDataGrid').datagrid({
            url : '${path }/miStandardMap/miStandardDataGrid',
            fit : true,
            striped : true,
           // rownumbers : true,
            pagination : true,
    	...
    	$('#diagnosisEditForm').form({
   		 url :'${path }/miStandardMap/updatemiStandardMap',
   		 onSubmit : function() {
                  progressLoad();
              ...
              success : function(result) {
              	...
              	{
               	   hideDiv2();
               	miStandardDataGrid.datagrid('load', $.serializeObject($('#searchForm')));
    ...
    function deleteFun() {
       /*  if (id == undefined) {//点击右键菜单才会触发这个
   	 ...
   	 var ss = "";
     var rows = $('#miStandardDataGrid').datagrid('getSelections');
     if(rows.length<1){
     ...
     for(var i=0; i<rows.length; i++){
        ...
        parent.$.messager.confirm('询问', '您是否要删除当前记录？', function(b) {
            if (b) {
                ...
                if (b) {
                    progressLoad();
                    $.post('${path }/miStandardMap/deleteMiStandardMap', {
                        id : ss
                    }, function(result) {
                        if (result.success) {
                            parent.$.messager.alert('提示', result.msg, 'info');
                            miStandardDataGrid.datagrid('reload');
                        }
                        progressClose();
                    }, 'JSON');
                }
    ...
    function editDiagnosisFun() {
        ...
        if(rows.length>1){
    	 ...
    	 $.post('${path }/miStandardMap/editPage', {
    		 Id : id
           }, function(result) {
          	 showDiv2(); 
               $('#id').val(result.id);
               $('#projectCodeEdit').val(result.projectCode);
               $('#projectNameEdit').val(result.projectName);             
               $('#standardCodeEdit').val(result.standardCode);             
               $('#standardNameEdit').val(result.standardName);             
    ...
    function cleanFun() {
    	$('#searchForm')[0].reset();
        miStandardDataGrid.datagrid('load', {});
    }
    ...
    function importExcel()
    {
    	var imgobjs=document.getElementById("daoru");
       	...
       	$(imgobjs).fileUpload(
    		{
    			uploadURL : '${path}/miStandardMap/importExcel',
    ...
    function exportMIStandardMap()
    {
    	...
    	location.href='${path}/miStandardMap/exportMIStandardMap';
    	
    }
    function exportMIStandardMapHistory()
    {
    	parent.$.messager.alert({
            title : '提示',
            msg : '正在导出数据... 请耐心等待！'
    	...
    	location.href='${path}/miStandardMap/exportMIStandardMapHistory';
    }
    function exportTemp()
    {
    	location.href='${path}/miStandardMap/exportTemp';
    }
</script>
</head>
<body>
...
<jsp:include page="../include/tophead.jsp" />
	...
	<div class="body-width fs_18 bold header-color">项目标准映射编码管理</div>
  ...
  <div  style="width: 80%;float: left">
    <table class="ys-table" style="width: 95%">
        ...
        <tr>
            ...
            <td>
               <input name="projectCode"  id="" style="width:120px;height: 30px;" />
            </td>
            ...
            <td>
               <input name="projectName"  id="" style="width:120px;height: 30px;" />
            </td>
   ...
   <table id="btn-table" class="float margin-top10" style="width: 100%;">
    <tr>
        ...
        <td class="right" style="width: 80px">
            <button class="btn-ok fs_16" onclick="exportMIStandardMap()">导出明细</button>
        </td>
        <td class="right" style="width: 96px">
            <button class="btn-ok fs_16" style="width: 91px;" onclick="exportMIStandardMapHistory()">查看历史记录</button>
        </td>
    </tr>
</table>

	<div class="body-width   margin-top15" style="height: 340px; overflow-x: auto;">
		<table class="sf-msg-table border-val" id="miStandardDataGrid"style="width: 100%">
    ...
    <div class="DialogDiv1" style="display: none">
        <div class="pop-up bg-color1">
            <span class="float pop-up-span width-color dis-block">项目标准映射编码管理新增</span>
        </div>
        ...
        <div class="body-width border-val" style="height: 250px;margin-top: 20px !important;width: 94%;margin-left: 3%;">
            <table class="bz-zd-table">
                ...
                <tr>
                    ...
                    <td>
                      <input name="projectCode"  id="projectCodeAdd" type="text" class="easyui-validatebox" validateOnCreate="false"
                    ...
                    <td >
                       <input name="projectName" type="text"  id="projectNameAdd" class="easyui-validatebox" validateOnCreate="false"
                    ...
                    <td>
                      <input name="standardCode"  id="standardCodeAdd"  type="text" validateOnCreate="false"
                    ...
                    <td>
                      <input name="standardName"  id="standardNameAdd"   type="text" validateOnCreate="false"
    ...
    <div class="DialogDiv2" style="display: none">
        <div class="pop-up bg-color1">
            <span class="float pop-up-span width-color dis-block">项目标准映射编码管理修改</span>
        </div>
               ...
               <table class="bz-zd-table">
                ...
                <tr>
                    ...
                    <input name="id"  id="id" type="hidden"  >
                      <input name="projectCode"  id="projectCodeEdit" type="text" class="easyui-validatebox" validateOnCreate="false"
                        validType="account[1,40]"  data-options="required:true" >
                    </td>
                    ...
                    <td >
                       <input name="projectName" type="text"  id="projectNameEdit" class="easyui-validatebox" validateOnCreate="false"
                         validType="length[1,50]"   data-options="required:true" >
                    </td>
                 ...
                 <tr>
                    ...
                    <td>
                      <input name="standardCode"  id="standardCodeEdit"  type="text" validateOnCreate="false"
                       class="easyui-validatebox" validType="account[1,40]"  data-options="required:true">
                    </td>
                      <td>
                        <span>*</span>标准名称
                    ...
                    <td>
                      <input name="standardName"  id="standardNameEdit"   type="text" validateOnCreate="false"
                       class="easyui-validatebox" validType="length[1,50]"  data-options="required:true">
                    </td>
                </tr>
                 <tr >
